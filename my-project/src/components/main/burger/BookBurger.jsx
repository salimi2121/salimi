             ...
             max-[530px]:px-7 max-[440px]:px-4">
                <FadeInDown>
                    <div className="flex flex-col gap-4 justify-start items-start pt-20 pb-10 ">
                        <p className="text-white font-bold uppercase z-1">Reservation </p>
                        <h1 className="text-white md:text-5xl -z-1 max-[800px]:text-4xl max-[565px]:text-3xl max-[500px]:text-2xl max-[565px]:px-4 max-[405px]:font-bold text-center font-extrabold uppercase">BOOK A TABLE</h1>
                        <p className="lg:w-2/4 sm:w-3/4 text-lg -z-1 max-[565px]:px-4 max-[765px]:text-lg max-[565px]:text-[1rem] text-white mt-2">Resy is another popular restaurant reservations. can explore restaurants, menus, and make reservations through their website.</p>
                    </div>
                </FadeInDown>
                <FadeInUp>
                    <div className="flex flex-col justify-center relative z-20 gap-1 lg:w-2/4 w-full pb-30 ">
                        <input type="text" className=" border z-10 border-gray-600 font-semibold hover:outline-0 focus-visible:outline-0 text-white p-5 rounded-xl opacity-90 text-lg bg-white/5 mb-7 transition-all duration-300 ease-out placeholder-white" placeholder="Enter your name" />
                        <input type="text" className="border z-10 border-gray-600 font-semibold hover:outline-0 focus-visible:outline-0 text-white p-5 rounded-xl opacity-90 text-lg bg-white/5 mb-7 transition-all duration-300 ease-out placeholder-white" placeholder="Enter your Email " />
                        <div className="relative flex lg:flex-row flex-col justify-start items-start gap-2 lg:gap-6 z-20 ">
                            ...
                            <div className="relative flex lg:w-2/4 w-full mb-7 z-30 text-white bg-white/5 rounded-xl border  border-gray-600">
                                <DateInput inputStyle={dateInputStyle} />
                                <span className="absolute right-5 top-6 text-white text-xl"><MdDateRange /></span>
                            </div>
                        </div>
                        <div className="relative flex lg:flex-row flex-col justify-start items-start gap-2 lg:gap-6 z-10">
                            <div className="flex lg:w-2/4 w-full rounded-2xl mb-7 bg-white/5"><TimeSelect /></div>
                            <input type="text" className=" border lg:w-2/4 w-full z-10 border-gray-600 font-semibold hover:outline-0 focus-visible:outline-0 text-white p-5 rounded-xl opacity-90 text-lg bg-white/5 mb-7 transition-all duration-300 ease-out placeholder-white" placeholder="Enter your Phone" />

...
export default function TestimonialAbout() {
    ...
    return (
        <div className=" bg-white pb-12 px-27 gap-5 w-full max-w-full xl:px-30
            ...
            <div className="flex flex-col gap-4 justify-center items-center py-24 ">
                <FadeInDown>
                    <div className="flex flex-col gap-4 justify-center items-center ">
                        <p className="text-red-700 font-bold uppercase tracking-tighter"> Testimonial </p>
                        <h1 className="md:text-5xl max-[800px]:text-4xl max-[565px]:text-3xl max-[500px]:text-2xl max-[565px]:px-4 max-[405px]:font-bold text-center font-extrabold uppercase">Our client reviews</h1>
                        <p className="lg:w-2/3 sm:w-full text-lg tracking-normal font-semibold max-[565px]:px-4 max-[765px]:text-lg max-[565px]:text-[1rem]
                                    text-gray-600 text-center mt-2">Customer reviews sorted by rating, date, or relevance. See what others are saying to make informed purchasing decisions.</p>
                    </div>
                </FadeInDown>
            ...
            >
                {items.map((item, index) => (
                    <SwiperSlide key={index}>
                        <div className="flex flex-col gap-6 p-10 mx-2 max-[480px]:px-3 border-transparent bg-white rounded-2xl max-[490px]:w-full
                        transition-all duration-1000 ease-in-out shadow-[0px_0px_25px_0px_rgba(0,0,0,0.08)]">

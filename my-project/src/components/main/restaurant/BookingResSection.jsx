...
export default function BookingResSection() {
            ...
            <div className="container mx-auto">
                <div className=" flex gap-7 max-[1024px]:flex-col  text-white">
                    <div className="w-2/4 max-[1024px]:w-full ">
                        <FadeInDown>
                            <div className="flex flex-col max-[1024px]:justify-center max-[1024px]:items-center gap-1 my-7 max-[700px]:mb-2">
                                <div className="flex gap-3">
                                    ...
                                    <p className="text-[#ffb200] font-semibold uppercase">  Reservation </p>
                                </div>
                                <h2 className="text-[2.7rem] max-[1200px]:text-3xl max-[700px]:text-2xl font-extrabold 
                                        uppercase max-[890px]:text-center leading-17 max-[475px]:leading-10">
                                    Need reservation? booking your table now
                                </h2>
                                <p className="text-[#ffb200] mt-3 font-semibold capitalize"> Order online </p>
                                <a href={'#'} className="bg-green-600 mt-6 hover:bg-yellow-500 hover:text-white
                                  transition-all duration-300 ease-out cursor-pointer flex justify-center 
                                   ...
                                   xl:px-15 p-3 px-10 max-[1024px]:w-2/6 max-[700px]:w-3/6 max-[460px]:w-4/6 max-[515px]:px-5 max-[420px]:px-2 capitalize ">
                    ...
                    <div className="w-2/4 max-[1024px]:w-full pt-8 ">
                        <FadeInUp>

                            <div className="flex justify-center items-center py-12 px-7 bg-[#14a83a] rounded-t-2xl">

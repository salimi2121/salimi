...
export default function MovingbarPizza() {
    return (
        <div className="w-full overflow-hidden py-3 bg-gray-900">
            <div className="animate-marquee flex gap-8 whitespace-nowrap">
            <div className="flex gap-8 justify-center items-center">  
                <div>  
                    <svg fill="#be1109" width="19px" height="19px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">  

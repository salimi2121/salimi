...
export default function TestimonialPizza() {
    const items = [
        {
            id: 1,
            category: '',
                ...
                <FadeInDown>
                    <div className="flex flex-col gap-4 justify-center items-center ">
                        ...
                        <p className="lg:w-2/3 sm:w-full text-lg tracking-normal font-semibold max-[565px]:px-4 max-[765px]:text-lg max-[565px]:text-[1rem]
                                    text-gray-600 text-center mt-2">Highlight specific aspects of the product or service that are relevant to your target audience. Focus on features or customers are likely to find compelling.</p>
                    </div>
                </FadeInDown>

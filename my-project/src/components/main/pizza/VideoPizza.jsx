import bgvid from "../../../assets/pizza-page/video-section/bg1.jpg";
...
export default function VideoPizza() {
    ...
    return (
        <div className="h-[450px] bg-cover bg-center bg-no-repeat relative before:absolute before:z-1 before:content-[''] before:opacity-70 
        before:bg-gray-950 before:top-0 before:left-0 before:w-full before:h-full" style={{ backgroundImage: `url(${bgvid})` }}>
            <div className="mx-auto ">
                <FadeInDown>
                    <div className="flex flex-col gap-10 py-20 z-10">
                    <div className="relative flex items-center justify-center">
                        ...
                        <h1 className="mx-auto text-center uppercase text-white font-extrabold text-4xl max-[450px]:text-3xl w-3/6 max-[940px]:w-3/5   
                               max-[806px]:w-4/6 max-[725px]:w-5/6 leading-11 z-10">

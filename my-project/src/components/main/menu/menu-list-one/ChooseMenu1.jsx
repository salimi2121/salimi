...
import f1 from '../../../../assets/pages/menu2/choose/m2.jpg'
import f2 from '../../../../assets/pages/menu2/choose/m3.jpg'
import f3 from '../../../../assets/pages/menu2/choose/m4.jpg'
import f4 from '../../../../assets/pages/menu2/choose/m1.jpg'
import FadeInLeft from '../../../FadeInLeft';


export default function ChooseMenu1() {
    const foods = [
        {
            id: 1,
    ...
    return (
        <div className="">
            <div className="flex flex-col gap-15 justify-center items-center bg-pink-50 py-25 px-30 max-[1200px]:px-20
              max-[992px]:px-38 max-[950px]:px-30 max-[910px]:px-24 max-[880px]:px-19 max-[768px]:px-30 max-[710px]:px-24 max-[690px]:px-17 max-[650px]:px-14 max-[600px]:px-5
             max-[530px]:px-7 max-[440px]:px-4">
                <FadeInDown>
                    <div className="flex flex-col gap-4 justify-center items-center ">
                        <h1 className="tracking-tighter md:text-5xl max-[800px]:text-4xl max-[565px]:text-3xl max-[500px]:text-2xl max-[565px]:px-4 max-[405px]:font-bold text-center font-extrabold uppercase">Choose our Foods</h1>
                ...
                <div className="flex max-[1200px]:flex-col w-full gap-6 ">
                <div className="w-2/4 max-[1200px]:w-full">
                    ...
                    <div className="basis-2/4 max-[1200px]:w-full grid grid-cols-1 gap-6">
                        {
                            foods.map((food) => (
                                <div className="flex max-[768px]:flex-col gap-4 max-[768px]:gap-6 justify-center items-center max-[1200px]:justify-start max-[768px]:items-start max-[768px]:p-4 bg-white ">
                                    <div className=" flex 

...
const SubMenuPizza = ({ title, options }) => {  
    ...
    return (  
        ...
        >  
            <button  
                ...
                >  
                    <span className='group-hover:text-green-600 transition-text duration-200 '>{title}</span>
                    <svg
                        ...
                        data-v-2b232355=""
                        className="mt-2 group-hover:text-green-600 transition-text duration-200"
                    >
                        <path
